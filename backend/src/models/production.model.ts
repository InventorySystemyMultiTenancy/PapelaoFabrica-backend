...
export const productionTypeSchema = z.enum(["corte", "vinco"]).optional().nullable();
export const productionLocationSchema = z.enum(["interno", "terceirizado"]).optional().nullable();
